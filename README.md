...
<img src="docs/images/note.png" alt="NoteforJun 메모 창. 상단바에 제목과 핀·도움말·메뉴·닫기 버튼이 있고, 본문에 큰 글씨 제목과 체크박스, 형광펜이 적용된 메모가 적혀 있다." width="620">

여백이 많아 보이는 건 의도입니다. 적을 자리부터 내밉니다.
