 ...
 *
 * 서명(.sig)은 TAURI_SIGNING_PRIVATE_KEY_PATH 를 걸고 빌드해야 생긴다.
 * 없으면 여기서 멈춘다. 서명 없는 업데이트는 설치되지 않는다.
 */
...
if (!existsSync(sig)) {
  ...
  console.error('TAURI_SIGNING_PRIVATE_KEY_PATH 를 걸고 npm run tauri build 를 다시 하세요.')
  process.exit(1)
}
