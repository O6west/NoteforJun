...
impl Default for WindowState {
    fn default() -> Self {
        Self { x: 48, y: 48, width: 460, height: 540, visible: true }
    }
}
...
Run: `npm test`
Expected: PASS — 53 + bubble 15 + preview 10 + search 6 = 84개 통과
...
- [ ] (추가) **첫 줄**을 드래그해도 팝업이 상단바와 손잡이를 덮지 않는다 — 아래로 내려가야 한다
- [ ] (추가) **마지막 줄**을 드래그해도 팝업이 창 아래로 빠져나가지 않는다
- [ ] (추가) **줄 끝**을 드래그해도 형광펜 버튼이 창 밖으로 밀려나가지 않는다
